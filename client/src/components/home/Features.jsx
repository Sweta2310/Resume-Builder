...
const Features = () => {
  ...
  return (
     <div id ="features" className ='flex flex-col items-center my-10 scroll-mt-12'>
        <div className="flex items-center gap-2 text-sm text-blue-600 bg-blue-400/10 rounded-full px-6py-1.5">
            <Zap width ={14}/>
            <span>Ensuring smooth and responsive support</span>
        </div>
        <Tittle tittle = 'Build your resume' description ='Let AI transform your experience into a standout resume Smart suggestions, clean templates, and instant polish'/>
            <div className="flex flex-col md:flex-row items-center xl:mt-1">
