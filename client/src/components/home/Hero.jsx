            ...
            <div className="min-h-screen pb-20">
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Upgrade your job search using <span className=" bg-gradient-to-r from-indigo-700 to-indigo-600 bg-clip-text text-transparent text-nowrap">Next-Gen AI Technology</span> resumes.
                    </h1>

                    <p className="max-w-md text-center text-base my-7">Build faster with 300+ elegant UI components designed to help you create beautiful, responsive interfaces with ease.</p>
