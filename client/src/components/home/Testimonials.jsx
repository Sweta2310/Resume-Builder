...
const Testimonials = () => {
  ...
  return (
    ...
    <div id ="testimonials" className ='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Tittle tittle = 'Design Your Perfect Resume' description ='Use AI to turn your experience into a clean, professional resume. Smart formatting, tailored guidance, and instant improvements'/>
    </div>
